...
<div class="col-md-12 card">
	...
	<form class="row" style="justify-content: space-between;">
		<select id="year" name="year" style="width:100px" class="form-control">
		...
		<div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 150px;">
                    <input type="text" name="amt" class="form-control float-right" placeholder="검색할 매입금액의 합계"
	...
	<!-- items : 배열, Collection(list, Set), Map(hashTable, hashMap, sortedMap) -->
		...
		<c:forEach var="data" items="${data.content}">
                    <tr>
                      ...
                      <td><fmt:formatNumber value="${data.buyQty}" type="number" pattern="#,###"/> 개</td>
                      <td><fmt:formatNumber value="${data.amt}" type="number" pattern="#,###"/> 원</td>
                    </tr>
		</c:forEach>
                  </tbody>
                </table>
